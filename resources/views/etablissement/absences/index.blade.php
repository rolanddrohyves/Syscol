{{-- resources/views/etablissement/absences/index.blade.php --}}
@extends('layouts.app')

@section('title', 'Gestion des absences - SYSCOL')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('etablissement.absences.export') }}?format=csv" 
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $stats['justifiees'] ?? 0 }}</p>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6">
        <form method="GET" action="{{ route('etablissement.absences.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
            ...
            <div>
                ...
                <select name="type" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500">
                    ...
                    <option value="sortie_anticipée" {{ request('type') == 'sortie_anticipée' ? 'selected' : '' }}>Sortie anticipée</option>
                </select>
            </div>
            
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Statut</label>
                <select name="justifiee" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500">
            ...
            <div class="flex items-end space-x-2">
                ...
                <a href="{{ route('etablissement.absences.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('etablissement.absences.show', $absence->id) }}" 
                                   class="p-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100"
                                   title="Voir détails">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('etablissement.absences.edit', $absence->id) }}" 
...
<script>
    ...
    function submitJustification() {
        if (currentAbsenceId) {
            ...
            form.action = `/etablissement/absences/${currentAbsenceId}/justify`;
    ...
    document.getElementById('confirmDelete').addEventListener('click', function() {
        if (currentAbsenceId) {
            const form = document.getElementById('actionForm');
            form.action = `/etablissement/absences/${currentAbsenceId}`;
