{{-- resources/views/admin/communications/show.blade.php --}}
@extends('layouts.app')

@section('title', 'Détail du message - Super Admin')
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="border-b border-gray-200 pb-4 mb-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-800">{{ $message->sender->name ?? 'Admin' }}</p>
                        @if($message->sender && $message->sender->etablissement)
                            <p class="text-xs text-gray-400">{{ $message->sender->etablissement->nom }}</p>
                        @endif
                    </div>
                    <div>
            ...
            <div class="border-t border-gray-200 pt-4 mb-4">
                ...
                <form action="{{ route('admin.communications.reply', $message->id) }}" method="POST">
                    @csrf
            ...
            <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                ...
                <form action="{{ route('admin.communications.destroy', $message->id) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
