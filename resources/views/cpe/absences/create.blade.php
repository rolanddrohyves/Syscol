{{-- resources/views/cpe/absences/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Signaler une absence - CPE')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm p-8">
        ...
        <!-- Formulaire -->
        <form action="{{ route('cpe.absences.store') }}" method="POST" class="space-y-8">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="classe_id" 
                                id="classe_id"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all @error('classe_id') border-red-500 @enderror"
                                required>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="eleve_id" 
                                id="eleve_id"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all @error('eleve_id') border-red-500 @enderror"
                                required>
            ...
            <div class="space-y-6 pt-6 border-t border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="type" 
                                id="type"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all @error('type') border-red-500 @enderror"
                                required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all @error('date') border-red-500 @enderror"
                               required>
                        @error('date')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="space-y-2" id="heureField" style="{{ old('type') == 'retard' ? '' : 'display: none;' }}">
                        ...
                        <input type="time" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all @error('heure') border-red-500 @enderror">
                        @error('heure')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="space-y-6 pt-6 border-t border-gray-100">
                <h3 class="text-lg font-semibold text-gray-800 flex items-center">
                    <i class="fas fa-pen-alt text-orange-600 mr-2"></i>
                    Motif (optionnel)
                </h3>
                ...
                <div class="space-y-2">
                    <textarea name="motif" 
                              rows="3"
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all @error('motif') border-red-500 @enderror"
            ...
            <div class="space-y-4 pt-6 border-t border-gray-100">
                ...
                <div class="flex flex-wrap gap-3">
                    <button type="button" onclick="setAbsence()" class="px-4 py-2 bg-red-100 text-red-700 rounded-xl hover:bg-red-200 transition-all">
                        <i class="fas fa-times-circle mr-2"></i>Absence
                    </button>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-end gap-3 pt-6 border-t border-gray-100">
                ...
                <button type="submit" 
                        class="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-xl hover:from-orange-700 hover:to-red-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function() {
        ...
        // Afficher le champ heure si le type est retard
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        if (type === 'retard') {
            ...
            if (!heure) errors.push('Veuillez saisir une heure pour le retard');
        }
